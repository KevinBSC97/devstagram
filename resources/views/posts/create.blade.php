...
@section('contenido')
    <div class="md:flex md:items-center">
        <div class="md:w-1/2 px-10">
            ...
            id="dropzone" class="dropzone border-dashed border-2 w-full h-96 rounded flex flex-col justify-center 
            items-center">
                @csrf
            </form>
        </div>
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{route('posts.store')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <textarea name="descripcion" id="descripcion" placeholder="Descripción de la publicacion"
                        class="border p-3 w-full rounded-lg
