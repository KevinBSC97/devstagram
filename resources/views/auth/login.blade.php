        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-lg">
            <form method="POST" action="{{ route('login')}}" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <label class="text-gray-500 text-sm">Mantener la sesiòn abierta</label>
                </div>
                <input type="submit" value="Iniciar Sesiòn" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
            </form>
        </div>
    </div>
